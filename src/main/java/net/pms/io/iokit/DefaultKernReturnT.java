...
import net.pms.io.iokit.IOReturn.IOReturnSubsystem;
 ...
 * @author Nadahar
 */
@SuppressWarnings({"checkstyle:ConstantName", "checkstyle:MethodName", "checkstyle:JavadocVariable"})
public class DefaultKernReturnT implements KernReturnT {
	...
	public String toString() {
		...
		return "DefaultKernReturnT (0x" +  Long.toHexString(code & 0xFFFFFFFF) + ")";
	}
