...
import net.pms.util.jna.IORegistryEntryTRef;
import net.pms.util.jna.IOServiceT;
import net.pms.util.jna.IOServiceTRef;
import net.pms.util.jna.IOStringT;
...
import net.pms.util.jna.MachPortTRef;
import net.pms.util.jna.TaskPortT;
...
public interface IOKit extends Library {
	 ...
	 * <p>
	 * This function returns the next object in an iteration, or zero/null //TODO if no more
	 ...
	 *         iteration is returned, otherwise zero/null //TODO is returned. <b>The element
	 *         should be released by the caller by calling {@link #IOObjectRelease} when it is finished</b>.
	 */
	 ...
	 * and should be called when {@link #IOIteratorNext} returns zero/null //TODO. An invalid
	 * iterator can be reset and the iteration restarted.
	 *
	 * @param iterator an {@code IOKit iterator} handle.
	 * @return {@code true} if the iterator handle is valid, otherwise {@code false} is returned.
	 */
